...
var expressUseragent = (() => {
  ...
  var UserAgent = class _UserAgent {
    ...
    getBrowserVersion(string) {
      ...
      const match = (exp, index = 1) => {
        var _a2, _b2;
        const result = string.match(exp);
        return result ? (_b2 = (_a2 = result[index]) != null ? _a2 : result[1]) != null ? _b2 : "unknown" : null;
      };
      switch (browser) {
        case "Edge":
          return (_a = match(this.versions.Edge)) != null ? _a : "unknown";
        case "PhantomJS":
          return (_b = match(this.versions.PhantomJS)) != null ? _b : "unknown";
        case "Chrome":
          return (_c = match(this.versions.Chrome)) != null ? _c : "unknown";
        case "Chromium":
          return (_d = match(this.versions.Chromium)) != null ? _d : "unknown";
        case "Safari":
          return (_e = match(this.versions.Safari, 2)) != null ? _e : "unknown";
        case "Opera": {
        ...
        case "Firefox":
          return (_f = match(this.versions.Firefox)) != null ? _f : "unknown";
        case "WinJs":
          return (_g = match(this.versions.WinJs)) != null ? _g : "unknown";
        case "IE": {
          const ieMatch = string.match(this.versions.IE);
          if (ieMatch) {
            return (_i = (_h = ieMatch[2]) != null ? _h : ieMatch[1]) != null ? _i : "unknown";
          }
          return "unknown";
        }
        case "ps3":
          return (_j = match(this.versions.Ps3)) != null ? _j : "unknown";
        case "psp":
          return (_k = match(this.versions.Psp)) != null ? _k : "unknown";
        case "Amaya":
          return (_l = match(this.versions.Amaya)) != null ? _l : "unknown";
        case "Epiphany":
          return (_m = match(this.versions.Epiphany)) != null ? _m : "unknown";
        case "SeaMonkey":
          return (_n = match(this.versions.SeaMonkey)) != null ? _n : "unknown";
        case "Flock":
          return (_o = match(this.versions.Flock)) != null ? _o : "unknown";
        case "OmniWeb":
          return (_p = match(this.versions.OmniWeb)) != null ? _p : "unknown";
        case "UCBrowser":
          return (_q = match(this.versions.UC)) != null ? _q : "unknown";
        case "Facebook":
          return (_r = match(this.versions.Facebook)) != null ? _r : "unknown";
        default:
          if (browser !== "unknown") {
